...
class BookingFormPage(View):
    ...
    def post(self,request,pk):
        ...
        start_date=form.cleaned_data['start_date'] #use cleaned_data (booking not created yet)
        end_date=form.cleaned_data['end_date']
        
        if start_date<date.today():    #validation
        ...
        booking = form.save(commit=False)    # create booking
